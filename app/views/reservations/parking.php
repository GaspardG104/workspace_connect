...
<body class="bg-light">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm mb-4 border-0">
            <div class="card-body">
                <h5 class="card-title mb-3"><i class="fa-solid fa-map-location-dot me-2"></i> Sélectionnez une place
                </h5>
                <div class="parking-map">
                    <?php foreach($resources as $r): ?>
                    <div class="place-btn" id="btn-<?= $r['id'] ?>"
                        onclick="selectPlace(<?= $r['id'] ?>, '<?= htmlspecialchars($r['nom']) ?>')">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-6">
                                        <label id="label-count" class="small fw-bold">Pendant combien de fois ?</label>
                                            <input type="number" name="recurrence_count" id="recurrence_count" class="form-control form-control-sm"
                                            min="0" value="1">
                                    </div>
                                </div>
