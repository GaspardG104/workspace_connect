    ...
    <div id="app-container" class="col-lg-8 mb-4" data-user-id="<?= $_SESSION['user_id'] ?>">
        ...
        <div class="row g-3 mb-4 mt-2 p-3 bg-light rounded shadow-sm border">
            <div class="col-md-4">
                ...
                <input type="text" id="ajax-search" class="form-control shadow-sm"
                    placeholder="Taper pour chercher (nom, invité, salle)...">
            </div>
            <div class="col-md-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="fa-solid fa-exclamation-triangle me-2"></i>Confirmation de suppression
                </h5>
